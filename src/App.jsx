...
const experience = [
  ...
  },
  {
    ...
    location: "Remote",
    summary:
      "Extended fluid benchmarking to safety evaluations, reducing cost and noise. Paper accepted at CTB @ ICML 2026 and under review at NeurIPS 2026. Mentored by Diogo Cruz and Vamshi Bonagiri.",
    summaryContent: (
      <>
        Applied{" "}
        <a
